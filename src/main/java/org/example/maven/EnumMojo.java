...
import org.example.generator.impl.EnumGenerator;

@Mojo(name = "enum", defaultPhase = LifecyclePhase.GENERATE_SOURCES)
public class EnumMojo extends AbstractEosMojo {
    @Override
    public void execute() throws MojoExecutionException {
        try {
            ...
            String detectedPackage = packageName != null
                    ? packageName
                    : context.detectPackageName("enum");
